package cn.jbone.sso.server.pswd.config;

import cn.jbone.sso.server.pswd.action.ChangePasswordAction;
import cn.jbone.sso.server.pswd.action.InitChangePasswordAction;
