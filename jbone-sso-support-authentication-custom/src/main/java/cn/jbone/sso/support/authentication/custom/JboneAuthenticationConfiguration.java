...
public class JboneAuthenticationConfiguration {
    ...
    public AuthenticationHandler jboneAuthenticationHandler(UserApi userApi) {
        JboneAuthenticationHandler h = new JboneAuthenticationHandler(null, (ServicesManager)this.servicesManager.getIfAvailable(), this.jbonePrincipalFactory(),null, jboneConfiguration.getSso().getRequiredRole());
